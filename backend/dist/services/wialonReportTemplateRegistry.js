...
export const REPORT_TEMPLATE_PATTERNS = [
...
export function patternsForModule(module, opts) {
    const includeFallback = opts?.includeFallback ?? true;
    return REPORT_TEMPLATE_PATTERNS.filter((p) => p.module === module && (includeFallback || !p.fallback));
}
