...
export function hostingUrlFromApiBase(baseUrl) {
...
export function buildWialonHostingLoginUrl(hostingUrl, authHash, lang = 'en') {
...
export function buildWialonHostingVideoUrl(hostingUrl, authHash, unitId, channel, lang = 'en') {
    const base = hostingUrl.replace(/\/$/, '');
