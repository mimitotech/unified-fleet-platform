...
export function createApp() {
    ...
    app.use('/api/auth/forgot-password', rateLimit({ windowMs: 15 * 60_000, max: 10, message: 'Too many password reset attempts' }));
    app.use('/api/auth/reset-password', rateLimit({ windowMs: 15 * 60_000, max: 10, message: 'Too many password reset attempts' }));
