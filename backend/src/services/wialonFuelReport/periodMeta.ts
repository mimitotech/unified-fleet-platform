...
export function encodePeriodLocation(periodFromTs?: number, periodToTs?: number, location = ''): string {
...
export function decodePeriodLocation(location: string | null | undefined): {
  location: string;
  periodFromTs?: number;
  periodToTs?: number;
} {
