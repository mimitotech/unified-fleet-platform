...
-- Initial login (change immediately after first login):
--   admin@mimitotracking.co.ug
-- WARNING: Do not re-run the UPDATE block on production after the admin has changed their password.
-- Prefer the INSERT-only path below for first setup.
