...
const GENERATOR_SECTIONS: ChecklistSection[] = [
  {
    ...
    items: [
      { id: 'ge-0', name: 'Engine oil level and condition', category: 'engine', status: 'pending' },
      { id: 'ge-1', name: 'Oil leaks under/around engine', category: 'engine', status: 'pending' },
      { id: 'ge-2', name: 'Air filter condition / restriction indicator', category: 'engine', status: 'pending' },
      { id: 'ge-3', name: 'Fuel filter / water separator drained', category: 'engine', status: 'pending' },
      { id: 'ge-4', name: 'Belts and hoses (cracks, tension, leaks)', category: 'engine', status: 'pending' },
      { id: 'ge-5', name: 'Unusual noise / vibration at idle and load', category: 'engine', status: 'pending' },
      { id: 'ge-6', name: 'Engine hours meter reading recorded', category: 'engine', status: 'pending' },
    ],
  },
  {
    id: 'fuel-cooling',
    ...
    items: [
      { id: 'gf-0', name: 'Fuel level adequate for planned run', category: 'fuel', status: 'pending' },
      { id: 'gf-1', name: 'Fuel tank / lines free of leaks', category: 'fuel', status: 'pending' },
      { id: 'gf-2', name: 'Coolant level and radiator condition', category: 'cooling', status: 'pending' },
      { id: 'gf-3', name: 'Cooling fan / radiator fins clear of debris', category: 'cooling', status: 'pending' },
      { id: 'gf-4', name: 'Exhaust system secure; no excessive smoke', category: 'exhaust', status: 'pending' },
      { id: 'gf-5', name: 'Battery electrolyte / terminals clean and tight', category: 'electrical', status: 'pending' },
    ],
  },
  {
    ...
    items: [
      { id: 'gel-0', name: 'Control panel indicators / alarms normal', category: 'electrical', status: 'pending' },
      { id: 'gel-1', name: 'Voltage / frequency within rated range under load', category: 'electrical', status: 'pending' },
      { id: 'gel-2', name: 'ATS / changeover switch (if fitted) status OK', category: 'electrical', status: 'pending' },
      { id: 'gel-3', name: 'Emergency stop functional', category: 'safety', status: 'pending' },
      { id: 'gel-4', name: 'Grounding / earthing connections secure', category: 'electrical', status: 'pending' },
      { id: 'gel-5', name: 'Enclosure / canopy doors and weather seals', category: 'general', status: 'pending' },
    ],
  },
  {
    id: 'safety-site',
    title: 'Safety & Site',
    items: [
      { id: 'gs-0', name: 'Fire extinguisher present and charged', category: 'safety', status: 'pending' },
      { id: 'gs-1', name: 'Area clear of flammables / adequate ventilation', category: 'safety', status: 'pending' },
      { id: 'gs-2', name: 'Spill kit / drip tray available', category: 'safety', status: 'pending' },
      { id: 'gs-3', name: 'Warning signs / restricted access observed', category: 'safety', status: 'pending' },
      { id: 'gs-4', name: 'Unit clean and free of excessive oil/dirt', category: 'general', status: 'pending' },
    ],
  },
];
